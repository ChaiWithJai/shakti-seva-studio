...
class HermesRuntime:
    ...
    def inspect(self) -> HermesStatus:
        enabled = os.getenv("SHAKTI_HERMES_ENABLED") == "1" or os.getenv("SHAKI_HERMES_ENABLED") == "1"
    ...
    def run_case(self, case: dict[str, Any], trace: TraceLedger, cwd: Path) -> str:
        ...
        if not status.enabled:
            raise HermesError("live Hermes explanations are disabled; set SHAKTI_HERMES_ENABLED=1")
        prompt = (
